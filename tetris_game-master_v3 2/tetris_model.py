...
class BoardData(object):
    ...
    def __init__(self):
        ...
        self.highlightX = -1          # X-coordinate of the highlight
        self.highlightY = -1          # Y-coordinate of the highlight
        self.highlightDirection = 0   # Rotation of the highlight
        self.highlightShape = Shape() # Shape object for the highlight

        self.worstHighlightX = -1          # X-coordinate of the highlight
        self.worstHighlightY = -1          # Y-coordinate of the highlight
        self.worstHighlightDirection = 0   # Rotation of the highlight
        self.worstHighlightShape = Shape() # Shape object for the highlight
